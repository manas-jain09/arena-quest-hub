...
export function UserSettingsDialog({ open, onOpenChange, userId }: UserSettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] flex flex-col bg-white border border-gray-200 shadow-lg rounded-lg overflow-hidden">
        <DialogHeader className="border-b pb-4 flex-shrink-0 px-6 pt-6">
          <DialogTitle className="text-xl text-center font-semibold text-arena-darkGray">
            User Settings
          </DialogTitle>
        </DialogHeader>
        
        <Tabs defaultValue="profile" value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
          <div className="px-6 pt-4 flex-shrink-0">
            <TabsList className="grid grid-cols-6 w-full">
              <TabsTrigger value="profile" className="flex items-center gap-1 text-xs px-2">
                <User size={14} />
                <span className="hidden sm:inline">Profile</span>
              </TabsTrigger>
              <TabsTrigger value="links" className="flex items-center gap-1 text-xs px-2">
                <Link2 size={14} />
                <span className="hidden sm:inline">Links</span>
              </TabsTrigger>
              <TabsTrigger value="skills" className="flex items-center gap-1 text-xs px-2">
                <BookOpen size={14} />
                <span className="hidden sm:inline">Skills</span>
              </TabsTrigger>
              <TabsTrigger value="experience" className="flex items-center gap-1 text-xs px-2">
                <Briefcase size={14} />
                <span className="hidden sm:inline">Work</span>
              </TabsTrigger>
              <TabsTrigger value="achievements" className="flex items-center gap-1 text-xs px-2">
                <Award size={14} />
                <span className="hidden sm:inline">Certs</span>
              </TabsTrigger>
              <TabsTrigger value="account" className="flex items-center gap-1 text-xs px-2">
                <Lock size={14} />
          ...
          <div className="flex-1 overflow-hidden px-6">
            <ScrollArea className="h-full">
              <div className="py-4 pr-4">
                <TabsContent value="profile" className="space-y-4 animate-fade-in mt-0">
                  <Form {...profileForm}>
                ...
                <TabsContent value="links" className="space-y-4 animate-fade-in mt-0">
                  <Form {...profileForm}>
                ...
                <TabsContent value="skills" className="space-y-4 animate-fade-in mt-0">
                  <div className="bg-arena-lightGray/50 rounded-lg p-4 mb-4">
                    <h3 className="font-medium flex items-center gap-2">
                ...
                <TabsContent value="experience" className="space-y-6 animate-fade-in mt-0">
                  <div className="bg-arena-lightGray/50 rounded-lg p-4 mb-4">
                    <h3 className="font-medium flex items-center gap-2">
                ...
                <TabsContent value="account" className="space-y-4 animate-fade-in mt-0">
                  <Form {...passwordForm}>

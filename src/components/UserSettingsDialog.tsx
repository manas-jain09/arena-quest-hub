...
export function UserSettingsDialog({ open, onOpenChange, userId }: UserSettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] w-[95vw] max-w-[95vw] max-h-[90vh] flex flex-col bg-white border border-gray-200 shadow-lg rounded-lg p-4 sm:p-6 overflow-hidden">
        ...
        <Tabs defaultValue="profile" value={activeTab} onValueChange={setActiveTab} className="w-full mt-2">
          <TabsList className="grid grid-cols-3 mb-4 w-full">
            <TabsTrigger value="profile" className="flex items-center gap-1 text-xs sm:text-sm sm:gap-2">
              <User size={isMobile ? 14 : 16} />
              <span className="truncate">Personal Info</span>
            </TabsTrigger>
            <TabsTrigger value="links" className="flex items-center gap-1 text-xs sm:text-sm sm:gap-2">
              <Link2 size={isMobile ? 14 : 16} />
              <span className="truncate">Social Links</span>
            </TabsTrigger>
            <TabsTrigger value="account" className="flex items-center gap-1 text-xs sm:text-sm sm:gap-2">
              <Lock size={isMobile ? 14 : 16} />
              <span className="truncate">Account</span>
            </TabsTrigger>
          </TabsList>
          
          <ScrollArea className="flex-grow overflow-y-auto pr-0 sm:pr-4 h-[350px] sm:h-[400px]">
            <div className="pr-2 sm:pr-4">
              <TabsContent value="profile" className="space-y-4 animate-fade-in">
                <Form {...profileForm}>
                  <form id="profile-settings-form" onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-4">
                    <div className="bg-arena-lightGray/50 rounded-lg p-3 sm:p-4 mb-4">
                      <h3 className="font-medium flex items-center gap-2 text-sm sm:text-base">
                        <User size={isMobile ? 16 : 18} className="text-arena-red" />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">Full Name</FormLabel>
                          <FormControl>
                            <Input 
                              placeholder="Your name" 
                              className="border-gray-300 focus:border-arena-red text-sm sm:text-base"
                              {...field} 
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">Bio</FormLabel>
                          <FormControl>
                            <Textarea 
                              placeholder="Tell us about yourself" 
                              className="border-gray-300 focus:border-arena-red min-h-[100px] sm:min-h-[120px] text-sm sm:text-base"
                              {...field} 
                            />
                          </FormControl>
                          <FormMessage />
                    ...
                    <div className="bg-arena-lightGray/50 rounded-lg p-3 sm:p-4 mb-4 mt-6">
                      <h3 className="font-medium flex items-center gap-2 text-sm sm:text-base">
                        <GraduationCap size={isMobile ? 16 : 18} className="text-arena-red" />
                        Education
                      </h3>
                    </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">College Name</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-medium flex items-center gap-1 text-sm sm:text-base">
                              CGPA
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <AlertCircle size={isMobile ? 12 : 14} className="text-gray-400 cursor-help" />
                                  </TooltipTrigger>
                                  <TooltipContent>
                                    <p className="w-[180px] sm:w-[200px] text-xs">Enter your Cumulative Grade Point Average on a scale of 0-10.</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            </FormLabel>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="font-medium flex items-center gap-2 text-sm sm:text-base">
                              <MapPin size={isMobile ? 12 : 14} className="text-gray-500" />
                              Location
                            </FormLabel>
                            <FormControl>
                              <Input 
              ...
              <TabsContent value="links" className="space-y-4 animate-fade-in">
                <Form {...profileForm}>
                  <form id="links-settings-form" onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-4">
                    <div className="bg-arena-lightGray/50 rounded-lg p-3 sm:p-4 mb-4">
                      <h3 className="font-medium flex items-center gap-2 text-sm sm:text-base">
                        <Link2 size={isMobile ? 16 : 18} className="text-arena-red" />
                        <span className="truncate">Social Media Links</span>
                      </h3>
                    </div>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input 
                              ...
                              className="border-gray-300 focus:border-arena-red text-sm sm:text-base truncate"
                              {...field} 
                            />
                          </FormControl>
                          <FormMessage />
              ...
              <TabsContent value="account" className="space-y-4 animate-fade-in">
                <Form {...passwordForm}>
                  <form id="password-settings-form" onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-4">
                    <div className="bg-arena-lightGray/50 rounded-lg p-3 sm:p-4 mb-4">
                      <h3 className="font-medium flex items-center gap-2 text-sm sm:text-base">
                        <Lock size={isMobile ? 16 : 18} className="text-arena-red" />
                        Password Update
                      </h3>
                    </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">Current Password</FormLabel>
                          <FormControl>
                            <Input 
                              type="password"
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">New Password</FormLabel>
                          <FormControl>
                            <Input 
                              type="password"
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="font-medium text-sm sm:text-base">Confirm New Password</FormLabel>
                          <FormControl>
                            <Input 
                              type="password"
          ...
          <div className="mt-4 sm:mt-6 border-t pt-4 px-1">
            <DialogFooter className="flex flex-row items-center justify-between w-full gap-2 flex-wrap">
              <Button 
                variant="outline" 
                onClick={() => onOpenChange(false)}
                className="border-gray-300 hover:bg-gray-100 text-sm h-9"
              ...
              <Button 
                ...
                className="bg-arena-red hover:bg-arena-darkRed transition-colors text-sm h-9"
                size={isMobile ? "sm" : "default"}
              >
                {isLoading ? (
                  <>
